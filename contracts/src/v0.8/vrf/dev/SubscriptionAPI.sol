...
abstract contract SubscriptionAPI is ConfirmedOwner, IERC677Receiver, IVRFSubscriptionV2Plus {
  ...
  struct Config {
    ...
    // linkPremiumPercentage is the percentage of total gas costs that is added to the final premium for pli payment
   ...
   * @param linkNativeFeed address of the pli native feed
   */
