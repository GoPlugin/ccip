...
contract VRFV2PlusWrapper is ConfirmedOwner, TypeAndVersionInterface, VRFConsumerBaseV2Plus, IVRFV2PlusWrapper {
  ...
  // s_coordinatorLinkPremiumPercentage is the premium ratio in percentage for pli payment. For example, a
   ...
   *
   * @return wrapperLinkPremiumPercentage is the premium ratio in percentage for pli payment. For example, a value of 0
   *         indicates no premium. A value of 15 indicates a 15 percent premium.
   *
