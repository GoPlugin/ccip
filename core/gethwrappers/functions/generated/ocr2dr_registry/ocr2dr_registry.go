...
func DeployOCR2DRRegistry(auth *bind.TransactOpts, backend bind.ContractBackend, pli common.Address, linkEthFeed common.Address, oracle common.Address) (common.Address, *types.Transaction, *OCR2DRRegistry, error) {
...
func (_OCR2DRRegistry *OCR2DRRegistryTransactor) Initialize(opts *bind.TransactOpts, pli common.Address, linkEthFeed common.Address, oracle common.Address) (*types.Transaction, error) {
...
type OCR2DRRegistryInterface interface {
	...
	Initialize(opts *bind.TransactOpts, pli common.Address, linkEthFeed common.Address, oracle common.Address) (*types.Transaction, error)
