...
func DeployKeeperRegistryLogic(auth *bind.TransactOpts, backend bind.ContractBackend, mode uint8, pli common.Address, linkNativeFeed common.Address, fastGasFeed common.Address) (common.Address, *types.Transaction, *KeeperRegistryLogic, error) {
