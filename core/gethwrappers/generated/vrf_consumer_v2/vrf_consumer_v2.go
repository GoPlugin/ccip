...
func DeployVRFConsumerV2(auth *bind.TransactOpts, backend bind.ContractBackend, vrfCoordinator common.Address, pli common.Address) (common.Address, *types.Transaction, *VRFConsumerV2, error) {
