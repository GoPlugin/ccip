...
func DeployVRFCoordinatorTestV2(auth *bind.TransactOpts, backend bind.ContractBackend, pli common.Address, blockhashStore common.Address, linkEthFeed common.Address) (common.Address, *types.Transaction, *VRFCoordinatorTestV2, error) {
