...
func (_VRFCoordinatorV25 *VRFCoordinatorV25Transactor) SetLINKAndLINKNativeFeed(opts *bind.TransactOpts, pli common.Address, linkNativeFeed common.Address) (*types.Transaction, error) {
