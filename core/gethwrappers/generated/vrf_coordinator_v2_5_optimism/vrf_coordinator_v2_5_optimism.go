...
func (_VRFCoordinatorV25Optimism *VRFCoordinatorV25OptimismTransactor) SetLINKAndLINKNativeFeed(opts *bind.TransactOpts, pli common.Address, linkNativeFeed common.Address) (*types.Transaction, error) {
