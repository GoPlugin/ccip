...
func DeployVRFExternalSubOwnerExample(auth *bind.TransactOpts, backend bind.ContractBackend, vrfCoordinator common.Address, pli common.Address) (common.Address, *types.Transaction, *VRFExternalSubOwnerExample, error) {
