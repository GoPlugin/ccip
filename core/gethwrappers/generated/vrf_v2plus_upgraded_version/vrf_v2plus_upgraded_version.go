...
func (_VRFCoordinatorV2PlusUpgradedVersion *VRFCoordinatorV2PlusUpgradedVersionTransactor) SetLINKAndLINKNativeFeed(opts *bind.TransactOpts, pli common.Address, linkNativeFeed common.Address) (*types.Transaction, error) {
...
type VRFCoordinatorV2PlusUpgradedVersionInterface interface {
	...
	SetLINKAndLINKNativeFeed(opts *bind.TransactOpts, pli common.Address, linkNativeFeed common.Address) (*types.Transaction, error)
