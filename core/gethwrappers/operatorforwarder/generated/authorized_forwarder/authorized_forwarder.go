...
func DeployAuthorizedForwarder(auth *bind.TransactOpts, backend bind.ContractBackend, pli common.Address, owner common.Address, recipient common.Address, message []byte) (common.Address, *types.Transaction, *AuthorizedForwarder, error) {
