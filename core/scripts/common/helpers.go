...
import (
	...
	types2 "github.com/goplugin/plugin-libocr/offchainreporting2plus/types"
...
// ExplorerLink creates a block explorer pli for the given transaction hash. If the chain ID is
...
// ContractExplorerLink creates a block explorer pli for the given contract address.
