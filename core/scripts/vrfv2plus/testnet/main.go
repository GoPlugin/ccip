...
func main() {
	...
	case "coordinator-deploy":
		...
		coordinatorDeployLinkAddress := coordinatorDeployCmd.String("link-address", "", "address of pli token")
	...
	case "wrapper-configure":
		...
		coordinatorGasOverheadLink := cmd.Uint("coordinator-gas-overhead-link", 52_000, "amount of gas overhead in coordinator fulfillment for pli payment")
