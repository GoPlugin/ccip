...
// VRFCoordinatorV2Interface_LINK_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PLI'
...
//   - opts *bind.CallOpts
func (_e *VRFCoordinatorV2Interface_Expecter) PLI(opts interface{}) *VRFCoordinatorV2Interface_LINK_Call {
	return &VRFCoordinatorV2Interface_LINK_Call{Call: _e.mock.On("PLI", opts)}
}
