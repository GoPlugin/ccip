...
func testMaybeSubtractReservedLink(t *testing.T, vrfVersion vrfcommon.Version) {
	...
	// Insert an unstarted eth tx with pli metadata
	...
	// One subscriber's reserved pli should not affect other subscribers prospective balance.
	...
	// A subscriber's balance is deducted with the pli reserved across multiple keys,
	// i.e, gas lanes.
