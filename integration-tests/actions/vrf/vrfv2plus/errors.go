...
const (
	...
	ErrSetLinkNativeLinkFeed                       = "error setting Pli and ETH/PLI feed for VRF Coordinator contract"
	ErrCreateVRFV2PlusJobs                         = "error creating VRF V2 Plus Jobs"
	ErrRequestRandomnessDirectFundingLinkPayment   = "error requesting randomness with direct funding and pli payment"
